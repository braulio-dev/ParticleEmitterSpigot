...
public class ParticleEmitter extends ParticleInterface {
    ...
    public void setPosition(Vector offset) {
        this.offset = offset;
    }
    ...
    ParticleEmitter(org.bukkit.Particle type, int updatesPerSecond, EmitterInitialization initialization, EmitterLocalSpace local_space,
